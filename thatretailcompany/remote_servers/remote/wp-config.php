...
define('DB_NAME', 'trcwpdb8654_thatretailcompany_com_au');

/** MySQL database username */
define('DB_USER', 'mytrcw1005');

/** MySQL database password */
define('DB_PASSWORD', 'jlH7CLrj');

/** MySQL hostname */
define('DB_HOST', 'mysql-2.thatretailcompany.com.au');
