...
<?php /*----------------TRC TESTIMONIALS CORE HACK---------------------------------*/ ?>
						<?php if(!$args['submit_wrapper_begin']){ ?><p class="form-submit"><?php } else { echo $args['submit_wrapper_begin'];} ?>
							<input name="submit" type="submit" id="<?php echo esc_attr( $args['id_submit'] ); ?>" value="<?php echo esc_attr( $args['label_submit'] ); ?>" />
							<?php comment_id_fields( $post_id ); ?>
						<?php if(!$args['submit_wrapper_end']){ ?></p><?php } else { echo $args['submit_wrapper_end'];} ?>
 <?php /*----------------TRC TESTIMONIALS CORE HACK END∂----------------------------*/ ?>                        <?php do_action( 'comment_form', $post_id ); ?>
					</form>
				<?php endif; ?>
			</div><!-- #respond -->
