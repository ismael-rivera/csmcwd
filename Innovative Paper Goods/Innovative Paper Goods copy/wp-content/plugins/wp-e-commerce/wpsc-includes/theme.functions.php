...
//---------------------------------ISH CODE---------------------------------------		
		...
		$template_name = get_post_meta($products_page_id, '_wp_page_template', true);
		if($template_name == '') $template_name = 'products_page.php';
		array_push( $templates, $template_name, 'single.php' );
//---------------------------------ISH CODE---------------------------------------
		if ( is_single() )
