...
<div id="slogan"><p><strong>Your Slogan</strong></br> Your company slogan goes here and/or some type of synopsis that summarizes IPG\'s philosophy, or maybe a meesage to your customers also</p>
</div>
...
<table width="200" border="0" cellspacing="0" cellpadding="0">
  <tr>
    ...
    <td><input class="s" name="s" type="text" value="' . $query . '" 
	onfocus="if(this.value==this.defaultValue)this.value=\'\';"
	onblur="if(this.value==")this.value=this.defaultValue;"
	/></td>
    <td><button class="searchsubmit" type="submit" value="'. esc_attr__('Search') .'" /></td>
  </tr>
</table>	    
</div>
</form></div>
