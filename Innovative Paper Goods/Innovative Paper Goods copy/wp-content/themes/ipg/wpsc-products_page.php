...
*This div raps evrything on this page
*********************************************************************-->
<style type="text/css">
</style>
...
<!--*******************wpsc_categories wpsc_category_grid group******************-->     <?php else:?>
<!--*******************ul with list of categories******************-->
...
<!--BEGIN MODULE 4 THE LOOP-->	
<!--*********************************************************************-->
<div class="wpsc_default_product_list">
		<?php /** start the product loop here */?>
        <?php  $x = 0; $y = 0;  ?>
<table class="products_tbl" border="0" cellspacing="0" cellpadding="0">
<tr>        
				...
				<?php endif; ?>
					<div class="productcol">
						...
						<div class="wpsc_description">
							...
							echo mb_substr(get_the_content(),0,200);
							?>
								...
								<?php if(wpsc_product_has_stock()) : ?>
									<div class="wpsc_buy_button_container">
										<div class="wpsc_loading_animation">
											...
											<?php else: ?>
										<input type="submit" value="<?php _e('Order', 'wpsc'); ?>"/>
											<?php endif; ?>
...
<!--*******************END default_products_page_container********************--> 