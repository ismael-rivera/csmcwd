...
function twentyten_widgets_init() {
	...
	// Area 7, located just above the footer. Empty by default.
	register_sidebar( array(
	...
	// Area 8, located just above the footer. Empty by default.
	register_sidebar( array(
		'name' => __( 'Center Widget Area', 'twentyten' ),
		'id' => 'center-widget-area',
		'description' => __( 'The center widget area', 'twentyten' ),
		'before_widget' => '<li id="%1$s" class="widget-container %2$s">',
		'after_widget' => '</li>',
		'before_title' => '<h3 class="widget-title">',
		'after_title' => '</h3>',
	) );
	// Area 9, located just above the footer. Empty by default.
	register_sidebar( array(
...
//simple function to call out slogan and twitter link
function slogan_tweet() {
return	'<div id="message" class="grid">
<div id="slogan"><p><strong>Your Latest Tweet</strong></br>Open up a twitter account and use your latest tweets to alter this text. Use your latest tweet to alter the text</p>
</div>
	...
	register_post_type( 'special_offers',
		array(
			'labels' => array(
				...
				'singular_name' => __( 'Special Offers' )
			),
		'public' => true,
		'has_archive' => true,
		)
...
if ( function_exists( 'add_image_size' ) ) { 
	...
	add_image_size( 'homepage-thumb', 280, 90, true ); //(cropped)
}
 ...
 * @return string 
 */
function trim_text($input, $length, $ellipses = true, $strip_html = true, $link = true) {
	...
	//add read more... type permalinks to end of string
 if ($ellipses && $link) {
		$trimmed_text .= '<a href="'. get_permalink() . '">' . __( 'Read more &raquo;' ) . '</a>';
	}
	return $trimmed_text;
}
