...
function dpsc_pnj_grid_display($atts, $content=null) {
  ...
  $content .= '<tr>';
				$content .= '<td class="title"><p><a href="' . $prod_permalink . '" title="' .$product->post_title . '">' . __($product->post_title) . '</a></p></td>';
				$content .= '</tr><tr>';
                $content .= '<td><div class="dpsc_grid_product_image">';
                if ($main_image != '') {
                ...
                $content .= '<p class="detail">' . mb_substr($product->post_excerpt, 0, 80)  . '</p>';
