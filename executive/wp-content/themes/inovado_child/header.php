...
<body <?php body_class(); ?>>
	...
	if($data['header_layout']) {
		if(is_page('header-2')) {
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v2.php');
		} elseif(is_page('header-3')) {
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v3.php');
		} elseif(is_page('header-4')) {
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v4.php');
		} elseif(is_page('header-5')) {
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v5.php');
		} else {
		     //include_once('..framework/inc/headers/header-'.$data['header_layout'].'.php');
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-'.$data['header_layout'].'.php');
		}
	} else {
		if(is_page('header-2')) {
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v2.php');
			...
			include_once( dirname(__FILE__) . '/framework/inc/headers/header-v1.php');
		}
	}
	
	?>
    <?php //$sc = '[rev_slider homeslider]' ?> 	
